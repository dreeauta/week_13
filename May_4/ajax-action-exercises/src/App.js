  ...
  render() {
    ...
    return (
      <div>
        ...
        <button onClick={() => this.props.getWeather2(this.props.name)}>Get Weather with redux-thunk with error handling</button>
        <button onClick={() => this.props.getWeather3(this.props.name)}>Get Weather with redux-thunk with error handling and loading indicator</button>
